...
from wikipedia_tool import WikipediaContent, OnlineWikipediaContent, FakeWikipediaContent
...
if __name__ == '__main__':
    ...
    agent = Agent(
        ...
        system_prompt=(
            ...
            "Provide location as the closest big city.",
        )
    )
    @agent.tool
    ...
    reference_answers = [
        Mountain("Robson", "Prince George", 3954),
